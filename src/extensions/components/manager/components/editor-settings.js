...
function EditorSettings () {
    ...
    const editorSettings = useSelect(select => select('core/block-editor').getSettings());
    ...
    const defaultOptions = [
        {
            ...
            option: () => (
	            <TextControl
		            ...
		            onChange={ newTitlePlaceholder =>  onUpdate('titlePlaceholder', newTitlePlaceholder) }
                />
            )
        },
        {
            ...
            option: () => (
	            <TextControl
		            ...
		            placeholder={ __('Enter a body placeholder...', 'block-options') }
		            help={ __( 'Change the default gutenberg body placeholder.' ) }
		            value={ editorSettings.bodyPlaceholder ?? '' }
		            onChange={ newBodyPlaceholder =>  onUpdate('bodyPlaceholder', newBodyPlaceholder) }
                />
            )
        },
        {
		            ...
		            <ButtonGroup>
			            {
                            map(editorSettings.imageSizes, (imageSize, idx) => {
                                ...
                                const currentImageSize = editorSettings.imageDefaultSize ?? "";
                                const isActiveDefaultSize = isEqual(imageSize.slug, currentImageSize);
                                    
                                return <Button key={ idx } isPrimary={ isActiveDefaultSize } onClick={ () => onUpdate('imageDefaultSize', imageSize.slug) }>{ imageSize.name }</Button>;
                            })
                        }
		            </ButtonGroup>
	            </Flex>
                ...
                return (
	                <FormTokenField 
		                ...
		                onChange={ newCustomUnits => {
                            if (newCustomUnits.every(insertedUnit => suggestedUnits.includes(insertedUnit))) {
        ...
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Toggle focus mode in the editor.', 'block-options') }
        ...
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Change the toolbar position in the editor.', 'block-options') }
		            onChange={ hasFixedToolbar => onUpdate('hasFixedToolbar', hasFixedToolbar) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Toggle reduce UI in the editor.', 'block-options') }
		            onChange={ hasReducedUI => onUpdate('hasReducedUI', hasReducedUI) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Control image editing ability in the editor.', 'block-options') }
		            onChange={ imageEditing => onUpdate('imageEditing', imageEditing) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Disables custom color picker in the editor.', 'block-options') }
		            onChange={ disableCustomColors => onUpdate('disableCustomColors', disableCustomColors) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Disables custom font sizes in the editor.', 'block-options') }
		            onChange={ disableCustomFontSizes => onUpdate('disableCustomFontSizes', disableCustomFontSizes) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Disables custom gradients in the editor.', 'block-options') }
		            onChange={ disableCustomGradients => onUpdate('disableCustomGradients', disableCustomGradients) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Enable custom line height in the editor.', 'block-options') }
		            onChange={ enableCustomLineHeight => onUpdate('enableCustomLineHeight', enableCustomLineHeight) }
                />
            )
        },
        {
            ...
            option: () => (
	            <ToggleControl 
		            ...
		            help={ __('Enable custom spacing in the editor.', 'block-options') }
		            onChange={ enableCustomSpacing => onUpdate('enableCustomSpacing', enableCustomSpacing) }
                />
            )
        }
    ];
    ...
    const filteredOptions = defaultOptions.filter((option) => {
        ...
        return option.keywords.filter(keyword => keyword.indexOf(query) !== -1).length > 0;
    });
	...
	<div className="editorskit-editor-settings">
		...
		{
            (isEmpty(searchQuery) ? defaultOptions : filteredOptions).map((editorOption, idx) => {
