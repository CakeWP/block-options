...
class EditorsKit_Block_Assets {
	...
	public function editor_assets() {
		...
		wp_enqueue_script(
			...
			array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-data', 'wp-plugins', 'wp-components', 'wp-edit-post', 'wp-api-fetch', 'wp-editor', 'wp-hooks', 'lodash' ),
			time(),
			false
		);
		...
		if ( current_theme_supports( 'editorskit-devtools' ) ) {
			...
			if ( $theme_support ) {
				...
				wp_enqueue_script(
					...
					array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-plugins', 'wp-components', 'wp-edit-post', 'wp-api-fetch', 'wp-editor', 'wp-hooks', 'lodash' ),
					time(),
					false
				);
			}
