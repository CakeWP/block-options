...
/* harmony import */ var _extensions_shortcuts_heading_level__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./extensions/shortcuts/heading-level */ "./src/extensions/shortcuts/heading-level/index.js");
...
/* harmony import */ var _blocks_import__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./blocks/import */ "./src/blocks/import/index.js");
/* harmony import */ var _blocks_shareablock__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./blocks/shareablock */ "./src/blocks/shareablock/index.js");
...
function registerBlocks() {
  [_blocks_import__WEBPACK_IMPORTED_MODULE_28__, _blocks_shareablock__WEBPACK_IMPORTED_MODULE_29__].forEach(function (block) {
    if (!block) {
      return;
    }
...
var DownloadsModal = function DownloadsModal(_ref) {
  var clientId = _ref.clientId,
      ...
      filterDownloads = _ref.filterDownloads;
...
/***/ "./src/blocks/shareablock/components/edit.js":
/*!***************************************************!*\
  !*** ./src/blocks/shareablock/components/edit.js ***!
  \***************************************************/
/*! exports provided: default */
...
/* harmony import */ var _loading__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./loading */ "./src/blocks/shareablock/components/loading.js");
/* harmony import */ var _downloads__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./downloads */ "./src/blocks/shareablock/components/downloads.js");
/* harmony import */ var _inspector__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./inspector */ "./src/blocks/shareablock/components/inspector.js");
...
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_9___default()(Edit, _Component);

  function Edit() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_4___default()(this, Edit);
    ...
    _this.saveApiKey = _this.saveApiKey.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8___default()(_this));
    _this.updateApiKey = _this.updateApiKey.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8___default()(_this));
    _this.fetchDownloads = _this.fetchDownloads.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_8___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_5___default()(Edit, [{
    key: "componentDidMount",
    value: function componentDidMount() {}
  }, {
    key: "componentWillUnmount",
    ...
    key: "filterDownloads",
    value: function filterDownloads(keyword) {
      var _this4 = this;
      ...
      var updatedList = Object.entries(this.state.downloads.purchased_files).filter(function (item) {
        return item[1].category.toLowerCase().search(keyword.toLowerCase()) !== -1;
      });
      updatedList.forEach(function (_ref2) {
        var _ref3 = _babel_runtime_helpers_slicedToArray__WEBPACK_IMPORTED_MODULE_1___default()(_ref2, 1),
            key = _ref3[0];

        filtered[key] = _this4.state.downloads.purchased_files[key];
      });
      this.setState({
        filtered: {
    ...
    value: function render() {
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])(Fragment, null, error || hasApiKey && !hasValidApiKey ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])("div", {
        className: "editorskit-inline-error notice-error notice"
      }, __('Invalid API or Access Token.', 'block-options')) : null, isOpen && Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])(_downloads__WEBPACK_IMPORTED_MODULE_12__["default"], {
        clientId: this.props.clientId,
        onClose: function onClose() {
          _this5.onClose();
        },
        setIsInserting: function setIsInserting(key) {
          _this5.setIsInserting(key);
        },
        isInserting: isInserting,
        downloads: Object.keys(filtered).length > 0 ? filtered : downloads,
        filterDownloads: function filterDownloads(keyword) {
          _this5.filterDownloads(keyword);
        }
      }), apiKey && accessToken && hasValidApiKey ? Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])(Button, {
        isPrimary: true,
        isLarge: true,
        onClick: function onClick() {
          _this5.updateApiKey();
        }
      }, __('View Downloads', 'block-options'))) : Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_10__["createElement"])(TextControl, {
        value: apiKey,
...
/***/ "./src/blocks/shareablock/components/inspector.js":
/*!********************************************************!*\
  !*** ./src/blocks/shareablock/components/inspector.js ***!
  \********************************************************/
/*! exports provided: default */
...
function (_Component) {
  ...
  function Inspector(props) {
    ...
    _this.removeApiKey = _this.removeApiKey.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(Inspector, [{
    ...
    value: function render() {
      ...
      }, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])("p", null, __('Add API key and Access Token. Updating this API key will set all your downloads to use the new key.', 'block-options')), Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(TextControl, {
...
/* harmony import */ var _components_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/edit */ "./src/blocks/shareablock/components/edit.js");
/**
 * WordPress dependencies
 */
var __ = wp.i18n.__;
...
var hasBlockSupport = wp.blocks.hasBlockSupport;
var restrictedBlocks = ['core/block', 'core/freeform', 'core/shortcode', 'core/template', 'core/nextpage', 'editorskit/import', 'editorskit/shareablock'];
...
/***/ "./src/extensions/shortcuts/alignment/components/controls.js":
/*!*******************************************************************!*\
  !*** ./src/extensions/shortcuts/alignment/components/controls.js ***!
  \*******************************************************************/
/*! exports provided: default */
...
var RegisterAlignmentShortcut =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_6___default()(RegisterAlignmentShortcut, _Component);

  function RegisterAlignmentShortcut() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_1___default()(this, RegisterAlignmentShortcut);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_3___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_4___default()(RegisterAlignmentShortcut).apply(this, arguments));
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_2___default()(RegisterAlignmentShortcut, [{
    key: "triggerShortcut",
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_7__["createElement"])(KeyboardShortcuts, {
        bindGlobal: true,
        shortcuts: (_ref = {}, _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 'ctrl+alt+c', this.triggerShortcut), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 'ctrl+alt+r', this.triggerShortcut), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 'ctrl+alt+l', this.triggerShortcut), _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(_ref, 'ctrl+alt+j', this.triggerShortcut), _ref)
      }));
    }
  }]);

  return RegisterAlignmentShortcut;
}(Component);
...
}), withSpokenMessages])(RegisterAlignmentShortcut));

/***/ }),

/***/ "./src/extensions/shortcuts/alignment/index.js":
/*!*****************************************************!*\
  !*** ./src/extensions/shortcuts/alignment/index.js ***!
  \*****************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_controls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/controls */ "./src/extensions/shortcuts/alignment/components/controls.js");
/**
 * Internal dependencies
 */
...
/***/ "./src/extensions/shortcuts/heading-level/components/controls.js":
/*!***********************************************************************!*\
  !*** ./src/extensions/shortcuts/heading-level/components/controls.js ***!
  \***********************************************************************/
/*! exports provided: default */
...
var RegisterHeadingShortcuts =
/*#__PURE__*/
function (_Component) {
  _babel_runtime_helpers_inherits__WEBPACK_IMPORTED_MODULE_5___default()(RegisterHeadingShortcuts, _Component);

  function RegisterHeadingShortcuts() {
    var _this;

    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0___default()(this, RegisterHeadingShortcuts);

    _this = _babel_runtime_helpers_possibleConstructorReturn__WEBPACK_IMPORTED_MODULE_2___default()(this, _babel_runtime_helpers_getPrototypeOf__WEBPACK_IMPORTED_MODULE_3___default()(RegisterHeadingShortcuts).apply(this, arguments));
    _this.triggerShortcut = _this.triggerShortcut.bind(_babel_runtime_helpers_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4___default()(_this));
    return _this;
  }

  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(RegisterHeadingShortcuts, [{
    key: "triggerShortcut",
    value: function triggerShortcut(event) {
      var _this$props = this.props,
          selectedBlock = _this$props.selectedBlock,
          updateBlockAttributes = _this$props.updateBlockAttributes;
      var level = event.code.replace(/^\D+/g, '');
      updateBlockAttributes(selectedBlock.clientId, {
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(Fragment, null, Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_6__["createElement"])(KeyboardShortcuts, {
        bindGlobal: true,
        shortcuts: {
  ...
  return RegisterHeadingShortcuts;
}(Component);
...
/* harmony default export */ __webpack_exports__["default"] = (compose([withSelect(function () {
  ...
  return !props.isDisabled && props.selectedBlock !== 'undefined' && props.selectedBlock !== 'undefined';
}), withSpokenMessages])(RegisterHeadingShortcuts));

/***/ }),

/***/ "./src/extensions/shortcuts/heading-level/index.js":
/*!*********************************************************!*\
  !*** ./src/extensions/shortcuts/heading-level/index.js ***!
  \*********************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_controls__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/controls */ "./src/extensions/shortcuts/heading-level/components/controls.js");
/**
 * Internal dependencies
 */
