...
function editorskitTypographySettings(FilteredComponent) {
  return function (props) {
    ...
    useEffect(function () {
      var currentFeatureStatus = wp.data.select('core/edit-post').isFeatureActive('disableEditorsKitTypography'); // TODO: fix this hacky approach which is used to sync unsynchronized data.
