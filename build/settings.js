...
function (_Component) {
  ...
  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1___default()(EditorsKitDocs, [{
    ...
    value: function openModal(name) {
      ...
      fetch(window.editorskitSettings.url + 'docs/' + name).then(function (response) {
        ...
        return _this2.setState({
          html: marked__WEBPACK_IMPORTED_MODULE_6___default()(markdown),
          isLoaded: true,
          isOpen: true
        });
      });
    ...
    value: function render() {
      ...
      return Object(_wordpress_element__WEBPACK_IMPORTED_MODULE_5__["createElement"])(Fragment, null, Object(lodash__WEBPACK_IMPORTED_MODULE_7__["map"])(formatDocs, function (formats) {
