                ...
                <div className="w-full p-8 max-w-screen-2xl mx-auto lg:space-x-16 lg:flex space-y-16 lg:space-y-0">
                    <div className="flex-grow text-left">
                        ...
                        <div className="max-w-2xl mb-24">
                            <p className="mb-10 leading-loose">{__('Congratulations! You have access to our entire library of Gutenberg patterns and page layouts. You can add up to 3 page layouts or patterns to your site completely free.', 'extendify-sdk')}</p>
                            <p className="mb-6 leading-loose">{__('All patterns and page layouts are pre-designed to look beautiful with options to fit your style. They also keep your site running lightning fast by using only core blocks with no 3rd party page builder required.', 'extendify-sdk')}</p>
                            <a
                    ...
                    <div className="flex-shrink-0 flex items-end">
                        <div className="flex-grow flex items-center space-y-4 xl:space-y-8 flex-col">
                            ...
                            <button type="button" onClick={() => updateTypeAndClose('template')} className="bg-white hover:bg-gray-50 cursor-pointer border border-gray-300 flex space-y-4 flex-col items-center justify-center p-8 lg:px-0 w-80">
                                ...
                                <span className="text-extendify-bright underline text-base font-bold">
                                    {__('View page layouts', 'extendify-sdk')}
                                </span>
                            </button>
                        </div>
                    </div>
